...
class AnimalQuiz{
  var images = [
    "kırmızı", "mavi", "sarı", "siyah","yesil"
  ];


  var questions = [
    "Yukarıdaki görselde verilen rengin ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rengin ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rengin ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rengin ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rengin ingilizcesi nedir?"
...
class renklerSoru extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return new renklerSoruState();
  }
}

class renklerSoruState extends State<renklerSoru> {
  @override
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Image.asset(
                  ...
                  "asset/renkler/renklerSoru/${quiz.images[questionNumber]}.png",height: 100,width: 100,
                ),
