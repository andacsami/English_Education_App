...
class AnimalQuiz{
  ...
  var questions = [
    "Yukarıdaki görselde verilen rakamın ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rakamın ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rakamın ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rakamın ingilizcesi nedir?",
    "Yukarıdaki görselde verilen rakamın ingilizcesi nedir?"
...
class sayilarSoru extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return new sayilarSoruState();
  }
}

class sayilarSoruState extends State<sayilarSoru> {
  @override
            ...
            child: new Column(
              children: <Widget>[
                ...
                new Image.asset(
                  ...
                  "asset/sayilarSoru/${quiz.images[questionNumber]}.png",height: 100,width: 100,
                ),
